            ...
            <div className="bg-white shadow-lg rounded-lg overflow-hidden">
              <div className="p-6 sm:p-10">
                ...
                <p className="mb-6 text-gray-700 leading-relaxed">
                  Placeringsinfo.se publicerar information om lediga boenden och vårdplatser inom SoL, LSS, LRV, LPT, LVM och LVU. En stor del av informationen i vår databas är hämtad från Inspektionen för vård och omsorgs (&ldquo;IVO&rdquo;) registerplattform. Vi arbetar aktivt för att hålla informationen uppdaterad och aktuell, men vi reserverar oss för att inaktuell information kan förekomma.
                </p>
